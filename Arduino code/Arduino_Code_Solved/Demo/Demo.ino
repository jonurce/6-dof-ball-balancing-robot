...
void slowDemo(){ //demos the capabilities of the platform
    InverseKinematics(0, 0, hz_norm, 0, 0, 0);  //hx, hy, hz, nx, ny, ax
    moveServos(50, 0);
    delay(1000);

    InverseKinematics(0, 0, hz_norm, 0, 0.25, 0);  //hx, hy, hz, nx, ny, ax
    moveServos(50, 0);
    delay(1000);
    ...
    InverseKinematics(0, 0, hz_norm, -0.25, 0, 0);  //hx, hy, hz, nx, ny, ax
    moveServos(50, 0);
    delay(1000);
    ...
    for (float i = 0; i <= 2*PI; i = i + 0.2){
      InverseKinematics(0, 0, hz_norm, 0.25*cos(i), 0.25*sin(i), 0); //hx, hy, hz, nx, ny, ax
      moveServos(0, 0);
    }
    delay(1000);
    ...
    InverseKinematics(0, 0, 105, 0, 0, 0);  //hx, hy, hz, nx, ny, ax
    moveServos(50, 0);
    delay(1000);

    InverseKinematics(0, 0, 140, 0, 0, 0);  //hx, hy, hz, nx, ny, ax
    moveServos(50, 0);
    delay(1000);
    ...
    InverseKinematics(0, 35, hz_norm, 0, 0, 0);  //hx, hy, hz, nx, ny, ax
    moveServos(50, 0);
    delay(1000);
    ...
    InverseKinematics(-35, 0, hz_norm, 0, 0, -35);  //hx, hy, hz, nx, ny, ax
    moveServos(50, 0);
    delay(1000);
    ...
    for (float i = 0; i <= 2*PI; i = i + 0.2){
      InverseKinematics(35*cos(i), 35*sin(i), hz_norm, 0, 0, 35*cos(i)); //hx, hy, hz, nx, ny, ax
      moveServos(0, 0);
    }
    delay(1000);
    ...
    InverseKinematics(0, 0, hz_norm, 0, 0, 35);  //hx, hy, hz, nx, ny, ax
    moveServos(50, 0);
    delay(1000);
...
void fastDemo(){ //demos the capabilities of the platform
    InverseKinematics(0, 0, hz_norm, 0, 0, 0);  //hx, hy, hz, nx, ny, ax
    moveServos(0, 0);
    delay(200);
...
void circulate(){ // circulates the platform
  for(float i = .1; i <= 1; i = i +.05 ){
    for (float j = 0; j <= 2*PI; j = j + i){
        InverseKinematics(0, 0, hz_norm, 0.25*cos(j), 0.25*sin(j), 0); //hx, hy, hz, nx, ny, ax
        moveServos(0, 0);
      }
  }
  delay(1000);
...
void circle(){ // circles the platform
  for(float i = .1; i <= 1; i = i +.05 ){
    for (float j = 0; j <= 2*PI; j = j + i){
        InverseKinematics(35*cos(j), 35*sin(j), hz_norm, 0, 0, 35*cos(j)); //hx, hy, hz, nx, ny, ax
        moveServos(0, 0);
      }
  }
